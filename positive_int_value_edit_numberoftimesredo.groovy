...
WebUI.click(findTestObject('Page_Hc liu - Sch Mm/a_Chnh sa'))

WebUI.setText(findTestObject('Page_Hc liu - Sch Mm/input_S ln lm li_form-control ng-untouched ng-valid ng-dirty'), '2')
