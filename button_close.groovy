...
WebUI.click(findTestObject('Page_Hc liu - Sch Mm/th_Cu s 1'))

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/button_ng'))

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/th_Cu s 2'))
